 ...
 * heap_destruir().
 * Pre:
 * Post: devuelve un heap , o NULL si hubo un error!!.
 */
 ...
 * Pre:
 * Post: devuelve un heap , en caso contrario devuelve NULL
*/
 ...
 * Post: libera la memoria del heap
 */
 ...
 * Pre: El Heap fue creado'
 * Post: Devuelve la cantidad de elemento del heap; 
*/
 ...
 * caso contrario.
 * Pre: El heap fue creado
 * Post : devuelve true si esta vacia , fasle en caso contrario.
*/
 ...
 * NULL.
 * Pre: el heap fue creado.
 * Post: Si esta vacio devuelve null , en caso contrario 
 *       devuele el maximo del heap.
 */
